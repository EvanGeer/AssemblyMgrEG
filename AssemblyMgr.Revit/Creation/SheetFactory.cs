...
namespace AssemblyMgr.Revit.Creation
{
    public class SheetFactory
    {
        ...
        public List<BuiltViewPort> Views { get; }
        public Dictionary<Direction3d, List<BuiltViewPort>> Schedules { get; }
        public List<BuiltViewPort> ModelViews { get; }

        public SheetFactory(List<BuiltViewPort> views)
        {
        ...
        public void PlaceSchedules(ViewSheet sheet, Dictionary<Direction3d, List<BuiltViewPort>> views, Document doc)
        {
            foreach (var direction in views)
            {
                ...
                {
                    if (!(view.View is ViewSchedule schedule && view.Definition is ViewPortDefinition_Schedule def)) continue;
        ...
        private static void PlaceModelViews(ViewSheet sheet, BuiltViewPort view, Document doc)
        {
